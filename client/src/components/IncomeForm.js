...
const formHandler = async (event) => {
  ...
  return (
    <div className="absolute w-auto left-1/2 transform -translate-x-1/2 mt-12 lg:mt-0 lg:top-60 lg:left-1/4 lg:ml-12">
    ...
    <button 
        type="submit" 
        onClick={formHandler}
        className="mb-4 bg-zinc-800 rounded-xl w-full border-solid border focus:bg-zinc-600"> Add income
    </button>
